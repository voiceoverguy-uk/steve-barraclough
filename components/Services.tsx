...
function ServiceItem({ icon, title }: { icon: React.ReactNode; title: string }) {
  return (
    <div className="flex items-center gap-3 bg-white border border-gray-100 rounded-xl px-4 py-3 hover:border-[#003da5]/30 hover:bg-blue-50/40 transition-all duration-200 group">
      <div className="flex-shrink-0 text-[#003da5] group-hover:text-[#003da5]">
        {icon}
      </div>
      <span className="font-medium text-[#0d1b2a] text-sm">{title}</span>
    </div>
  );
}
    ...
    <section id="services" className="py-14 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-[#0d1b2a] mb-3">
