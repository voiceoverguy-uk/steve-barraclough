const testimonials = [
  {
    ...
    location: "Pontefract",
    rating: 5,
    text: "Steve and his son were brilliant — turned up on time, explained everything clearly and had our boiler sorted the same day. Fair pricing, no fuss, and really friendly. Would absolutely recommend them to anyone in the area.",
  ...
  },
  {
    ...
    location: "Wakefield",
    rating: 5,
    text: "We had a new Worcester Bosch boiler installed and couldn't be happier. The work was neat and professional, and they left the place spotless. It's reassuring knowing they're accredited installers — and the extended warranty is a real bonus.",
  ...
  },
  {
    ...
    location: "Castleford",
    rating: 5,
    text: "I needed my annual gas safety certificate for my rental property and Steve was incredibly helpful. Booked me in quickly, turned up exactly when he said, and sorted the paperwork straight away. Will definitely be using them again.",
